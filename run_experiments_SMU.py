...
list_of_stages = []
list_of_stages.append(Stage(algorithm_type="MH", proposal_sd_or_cov=0.5, max_evaluations=25, surrogate_model_updates=True))
no_test_stages = 5
for i in range(no_test_stages):
    if i > 0:
        list_of_stages.append(Stage(algorithm_type="DAMH", proposal_sd_or_cov=0.5, max_evaluations=25, surrogate_model_updates=True))
    list_of_stages.append(Stage(algorithm_type="DAMH", proposal_sd_or_cov=0.5, max_evaluations=1000, surrogate_model_updates=False, is_excluded=True))
