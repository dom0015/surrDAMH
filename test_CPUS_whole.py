...
C = Configuration()
problem_name = "GRF_24to10_06_unlimited"
...
S.plot_evaluated(N,L=S.evaluated)
S.plot_evaluated(N,L=S.accepted)
S.plot_evaluated(N,L=S.rejected)

S.plot_evaluated_sliding(range(N), no_sw=50, L = S.evaluated, window_length=20000)

S.calculate_autocorr_time_sliding(no_sw=50, chains_range=range(N), window_length=20000)
