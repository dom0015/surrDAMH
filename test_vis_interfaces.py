...
reference_parameters = np.array([2, -1, 1, -2])
...
G.plot_realization_interfaces(quantiles=[0.5, 1.0], nx_new=n, ny_new=n)
...
problem_name = "interfaces_saving"
