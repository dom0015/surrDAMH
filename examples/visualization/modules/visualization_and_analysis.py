...
# module_path = path_up + "/solvers/grf_eigenfunctions.py" 
# spec = iu.spec_from_file_location("grf_eigenfunctions", module_path)
# grf_eigenfunctions = iu.module_from_spec(spec)
# spec.loader.exec_module(grf_eigenfunctions)
import examples.solvers.grf_eigenfunctions as grf_eigenfunctions
...
### GAUSSIAN RANDOM FIELDS:
    ...
    def plot_mean_and_std_grf_rotated_merged(self, burn_in = None, chains_disp = None, grf_path = None, grid_x = 50, grid_y = 50):
        # Algoritmy 2020 wrong rotation !
        if grf_path == None:
            grf_path = 'modules/unit50.pckl'
        grf_instance = grf_eigenfunctions.GRF(grf_path, truncate=self.no_parameters)
