...
class Solver_MPI_parent: # initiated by SOLVERS POOL
    def __init__(self, no_parameters, no_observations, no_samplers, problem_path, maxprocs=1):
        self.no_parameters = no_parameters
        self.no_observations = no_observations
        self.max_requests = 1
        self.comm = MPI.COMM_SELF.Spawn(sys.executable, args=['surrDAMH/process_CHILD.py',str(no_samplers),problem_path], maxprocs=maxprocs)
        self.tag = 0
