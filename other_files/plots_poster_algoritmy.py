...
tau = list(1.5*i for i in tau)
plt.plot(proposal_std, tau, 'o--')#,color='0.7')
plt.yscale("log")
# plt.xscale("log")
plt.grid(which="both")
...
# # plt.xscale("log")
# plt.grid(which="both")
# plt.legend(['MH autocorr. time','DAMH autocorr. time','DAMH eval. per uncorr.','DAMH cost per uncorr.'])
# plt.xlabel('proposal std')
# plt.show()